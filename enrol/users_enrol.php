                    ...
                    <div class="navbar-holder d-flex align-items-center justify-content-between">
                        ...
                        <div class="navbar-header">
                            <!-- Navbar Brand --><a href="#" class="navbar-brand d-none d-sm-inline-block">
                                <div class="brand-text d-none d-lg-inline-block"><span>User </span><strong>
                                        Dashboard</strong></div>
                                <div class="brand-text d-none d-sm-inline-block d-lg-none"><strong>User</strong></div>
                            </a>
...
$(document).ready(function() {
    $('#submit').click(function() {
        ...
        if ($('#first_name').val() === '') {
            ...
            alert('Sorry! region can\'t be empty');
        } else if ($('#district').val() === '') {
            alert('Sorry! district can\'t be empty');
        } else if ($('#district_code').val() === '') {
            alert('Sorry! district_code can\'t be empty');
