...
if (isset($_POST['submit_login'])) {
  ...
  $sql = "SELECT * FROM enrol WHERE staffID='$staff_id' AND staff_password='$pass' AND status_='admin'";
  // echo $sql;
  ...
  if ($count == 1) {
    ...
    $_SESSION['staff_password'] = $pass;
     ...
     header("Location:admin_enrol.php");
                                ...
                                <form method="POST" action="" class="form-validate">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-responsive">
                                            <tr>
                                                <td>
                                                    <!-- <label class="mr-sm-2" for="staffID">Staff ID</label> -->
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <input id="staffPassword" type="password" name="staffPassword"
                                                ...
                                                <td colspan="3">
                                                    <div align="center">
                                                        <button type="submit" class="btn btn-primary btn-sm float-right"
                                                            ...
                                                            value="submit_login">Check Admin</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
