...
<head>
    ...
    <link rel="stylesheet" href="../../IFAM/vendor/bootstrap/css/bootstrap.min.css">

    <!-- Font Awesome CSS-->
    <link rel="stylesheet" href="../../IFAM/vendor/font-awesome/css/font-awesome.min.css">
    <!-- Fontastic Custom icon font-->
    <link rel="stylesheet" href="../../IFAM/css/fontastic.css">
    <!-- Google fonts - Poppins -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,700">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="../../IFAM/css/style.default.css" id="theme-stylesheet">
    <!-- Custom stylesheet - for your changes-->
    <link rel="stylesheet" href="../../IFAM/css/custom.css">
    <!-- Favicon-->
    <link rel="shortcut icon" href="../../IFAM/img/favicon.jpg">
...
<body>
    <div class="page login-page">
                        ...
                        <div class="form d-flex align-items-center">
                            ...
                            if (mysqli_num_rows($district_result) > 0) {
                              while ($district_row = mysqli_fetch_array($district_result)) {
                                $show_district .= '
                                    <option value="' . $district_row['district_code'] . '">' . $district_row['district_name'] . '</option>
                                  ';
                              }
                            } else {
                              $show_district .= '
                            ...
                            <?php 
                            $show_region = '';
                            $region_sql = "SELECT * FROM district";
                            ...
                            if (mysqli_num_rows($region_result) > 0) {
                              while ($region_row = mysqli_fetch_array($region_result)) {
                                $show_region .= '
                                    <option value="' . $region_row['district_region'] . '">' . $region_row['district_region'] . '</option>
                                  ';
                              }
                            } else {
                              $show_region .= '
                            ...
                            <?php 
                            $show_location = '';
                            $location_sql = "SELECT * FROM district";
                            ...
                            if (mysqli_num_rows($location_result) > 0) {
                              while ($location_row = mysqli_fetch_array($location_result)) {
                                $show_location .= '
                                    <option value="' . $location_row['district_location'] . '">' . $location_row['district_location'] . '</option>
                                  ';
                              }
                            } else {
                              $show_location .= '
        ...
        <!-- JavaScript files-->
        <script src="../../IFAM/vendor/jquery/jquery.min.js"></script>
        <script src="../../IFAM/vendor/popper.js/umd/popper.min.js"> </script>
        <script src="../../IFAM/vendor/bootstrap/js/bootstrap.min.js"></script>
        <script src="../../IFAM/vendor/jquery.cookie/jquery.cookie.js"> </script>
        <script src="../../IFAM/vendor/chart.js/Chart.min.js"></script>
        <script src="../../IFAM/vendor/jquery-validation/jquery.validate.min.js"></script>
        <!-- Main File-->
        <script src="../../IFAM/js/front.js"></script>
</body>
