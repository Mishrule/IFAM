  ...
  <body>
    <div class="page">
                    ...
                    <div>Select the Location from the link below</div>
                      <div class="form-check" style="padding-top:10px;">
                        <span style="padding-right:50px;">
                          <input class="form-check-input"  type="radio" name="f_location" id="f_location1" value="option1" >
                            <a href="users_asset_register.php">Functional Location</a> 
                        </span >
                        <span>
                          <input class="form-check-input" type="radio" name="f_location" id="f_location2" value="option2" checked>
                            <a href="users_asset_register_residence.php">Residence Location</a>     
                        </span>
                      </div>
                    </div>
                      ...
                      <form action="<?php $_PHP_SELF ?>" method="POST" enctype="multipart/form-data">
                        <table class="table">
                         <tr>
                              <td><strong>MMDA/MDA:</strong><input type="text" class="form-control" id="mmda" name="mmda" placeholder="MMDA" value="<?php echo $session_login_district; ?>" disabled>
                              </td>
                              <td><strong>REGION:</strong><input type="text" class="form-control" id="region" name="region" placeholder="REGION" value="<?php echo $session_login_region; ?>" disabled>
                              </td>
                              <td><strong>DISTRICT:</strong><input type="text" class="form-control" id="district" name="district" placeholder="District" value="<?php echo $session_login_location; ?>" disabled>
                              </td>
                              <td>
                              </td>
                            </tr>
                            <tr>
                              <td colspan="4"><label for=""><strong><span style="color:red">ITEM DESCRIPTION</span></strong></label></td>
                            </tr>
                          <tr>
                          
                              <td><strong>ITEM NO.:</strong><input type="text" class="form-control" id="item" name="item" placeholder="Item No." required>
                              </td>
                              <td><strong>DESCRIPTION:</strong><input type="text" class="form-control" id="description" name="description" placeholder="DESCRIPTION" required>
                              </td>
                              <td>
                              <select class="custom-select d-block my-3 " id="id_show" name="id_show" required>
                            ...
                            <tr>
                              <td colspan="4"><label for=""><strong><span style="color:red">LOCATION</span></strong></label></td>
                            </tr>
                            <tr>
                              <!-- <td>
                            ...
                            <!-- <div id="dept_show_radio">
                              <select class="custom-select d-block my-3 " id="dept_show" name="dept_show" required>
      ...
      <!-------------------------- RESIDENCE -->
                            ...
                            <tr>
                              <td colspan="4"><label for=""><strong><span style="color:red">PURCHASE INFORMATION</span></strong></label></td>
                            </tr>
                            <tr>
                              <td><strong>DATE:</strong><input type="date" class="form-control" id="asset_date" name="asset_date" placeholder="Date" required>
                              </td>
                              <td><strong>SUPPLIER:</strong><input type="text" class="form-control" id="supplier" name="supplier" placeholder="SUPPLIER" required>
                              </td>
                              <td><strong>PRICE.:</strong><input type="text" class="form-control" id="price" name="price" placeholder="Price" required>
                              </td>
                              <td>
                              </td>
                            ...
                            <tr>
                              <td colspan="4"><label for=""><strong><span style="color:red">QUALITY AND VALUE</span></strong></label></td>
                            </tr>
                            <tr>
                              <td><strong>CONDITION:</strong><input type="text" class="form-control" id="condition" name="condition" placeholder="Condition" required>
                              </td>
                              <td><strong>UNIT VALUE:</strong><input type="text" class="form-control" id="unit_value" name="unit_value" placeholder="Unit Value" required>
                              </td>
                              <td><strong>QTY:</strong><input type="text" class="form-control" id="user_contact" name="user_contact" placeholder="Quantity" required>
                              </td>
                              <td>
                              </td>
                            ...
                            <tr>
                              <td colspan="4"><label for=""><strong><span style="color:red">ITEM DETAILS</span></strong></label></td>
                            </tr>
                            <tr>
                              <td><strong>MODEL NO.:</strong><input type="text" class="form-control" id="model_number" name="model_number" placeholder="Model No." required>
                              </td>
                              <td><strong>SERIAL NO.:</strong><input type="text" class="form-control" id="serial_no" name="serial_no" placeholder="Serial Number" required>
                              </td>
                              <td><strong>PHOTO INFO UNIT</strong><input type="file" class="form-control" id="photo" name="photo" placeholder="Photo Info Unit" required>
                              </td>
                              <td>
                              </td>
                            ...
                            <tr>
                                <td colspan="4">
                                  <div align="center">
                                    ...
                                    <button  type="submit" class="btn btn-dark btn-sm" id="register_asset" name="register_asset">Register Asset</button>
                                        <!-- </div> -->
                                    <a  href="preview_registered_asset.php" class="btn btn-primary btn-sm" id="register_asset" target="_blank" name="register_asset">Preview Registered Asset</a>
                                  </div>
                                </td>
                            </tr>
