                                        ...
                                        <div align="center">
                                            ...
                                            <div class="form-check" style="padding-top:10px;">
                                                <span style="padding-right:50px;">
                                                    <input class="form-check-input" type="radio" name="f_location"
                                                        id="f_location1" value="option1">
                                                    <a href="asset_register.php">Functional Location</a>
                                                </span>
                                                <span>
                                                    <input class="form-check-input" type="radio" name="f_location"
                                                        id="f_location2" value="option2" checked>
                               ...
                               <option value="">SELECT DEPT</option>
                                  ...
                                  <?php echo $dept_show; ?>
                                                            ...
                                                            <div id="residence_show_radio">
                                                                <select class="custom-select d-block my-3 "
                                                                    id="residence_show" name="residence_show" required>
                                                                    <option value="">SELECT DEPT</option>
                                                                    <?php 
                                $residence_show = '';
                                ...
                                <div id="room_show"></div>
                                                            ...
                                                            <div id="_residence_show_radio">
                                                                <select class="custom-select d-block my-3 "
                                                                    id="_residence_show" name="_residence_show"
                                                                    required>
