                        ...
                        <div class="row bg-white has-shadow">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="item d-flex align-items-center">
                                    ...
                                    <div class="title"><span>Total <br>Residence</span>
                                        <div class="progress">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="item d-flex align-items-center">
                                    ...
                                    <div class="title"><span>Total<br>Class Definition</span>
                                        <div class="progress">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="item d-flex align-items-center">
                                    ...
                                    <div class="title"><span>Total<br>Asset Set</span>
                                        <div class="progress">
                        ...
                        <div class="row">
                            ...
                            <div class="statistics col-lg-3 col-12">
                                <div class="statistic d-flex align-items-center bg-white has-shadow">
                                    ...
                                    <div class="text"><strong>234</strong><br><small>Units</small></div>
                                </div>
                                <div class="statistic d-flex align-items-center bg-white has-shadow">
                                    <div class="icon bg-green"><i class="fa fa-calendar-o"></i></div>
                                    <div class="text"><strong>152</strong><br><small>Tagging of Cards</small></div>
                                </div>
                                <div class="statistic d-flex align-items-center bg-white has-shadow">
                                ...
                                <div class="client card">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="client-social d-flex justify-content-between"><a href="#"
                                                ...
                                                target="_blank"><i class="fa fa-google-plus"></i></a><a href="#"
                                                target="_blank"><i class="fa fa-instagram"></i></a><a href="#"
                                ...
                                <div class="daily-feeds card">
                                    ...
                                    <div class="card-body no-padding">
                                        ...
                                        <div class="item clearfix">
                                            ...
                                            <div class="quote has-shadow"> <small>Lorem Ipsum is simply dummy text of
