                      ...
                      <div id="district_show"></div>
                        <table class="table">
                            <tr>
                              ...
                              <td><input type="text" class="form-control" id="district_name" name="district_name" placeholder="First name" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly Code:</td>
                              <td><input type="text" class="form-control" id="district_code" name="district_code" placeholder="Code" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly Region:</td>
                              <td><input type="text" class="form-control" id="district_region" name="district_region" placeholder="Region" required></td>
                            </tr>   
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly Location:</td>
                              <td><input type="text" class="form-control" id="district_location" name="district_location" placeholder="Location" required></td>
                            </tr>
                            <tr>
                              <td colspan="2"><div align="center"><button type="button" class="btn btn-primary btn-sm " id="district_submit" name="district_submit" value="district_submit">Register District</button></div></td>
                            </tr>                        
                        </table>
                      </div>
                    </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="table-responsive">                       
                        <table class="table table-striped table-hover">
                          <select class="custom-select d-block my-3" id="district_details" name="district_details" required>
                          ...
                          <thead>
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly Name:</td>
                              <td><input type="text" class="form-control" id="district_name_update" name="district_name_update" placeholder="First name" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly Code:</td>
                              <td><input type="text" class="form-control" id="district_code_update" name="district_code_update" placeholder="Code" disabled></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly Region:</td>
                              <td><input type="text" class="form-control" id="district_region_update" name="district_region_update" placeholder="Region" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly Location:</td>
                              <td><input type="text" class="form-control" id="district_location_update" name="district_location_update" placeholder="Location" required></td>
                            </tr>  
                            <tr>
                              <td colspan="2">
                                <div align="center">
                                  <button type="button" class="btn btn-success btn-sm " id="district_submit_update" name="district_submit_update" value="district_submit_update">Update District
                                  </button>
  ...
  $(document).ready(function(){
    ...
    $('#district_submit').click(function(){
      ...
      $.ajax({
        ...
        method:'POST',
        data:{district_name:district_name, district_code:district_code, district_region:district_region, district_location:district_location,district_submit:district_submit},
    ...
    $('#district_submit_update').click(function(){
      if(confirm("Are you sure you want to update the district")){
        ...
        $.ajax({
          url:'../../script/districtScript.php',
          method:'POST',
          data:{district_name_update:district_name_update, district_code_update:district_code_update, district_region_update:district_region_update, district_location_update:district_location_update, district_submit_update:district_submit_update},
