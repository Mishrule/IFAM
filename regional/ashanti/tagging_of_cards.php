                      ...
                      <div class="table-responsive">
                         <table class="table">
                            <tr>
                              ...
                              <td><input type="date" class="form-control" id="tagging_required_date" name="tagging_required_date"  required></td>
                            </tr>
                            <tr>
                              <td style="float:right;">Name of Asset:</td>
                              <td><input type="text" class="form-control" id="tagging_asset_name" name="tagging_asset_name" placeholder="Name of Asset" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">Date Transferred:</td>
                              <td><input type="date" class="form-control" id="tagging_transferred_date" name="tagging_transferred_date"  required></td>
                            </tr>
                            <tr>
                              <td style="float:right;">New Location:</td>
                              <td><input type="text" class="form-control" id="tagging_location" name="tagging_location" placeholder="New Location" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">Authority:</td>
                              <td><input type="text" class="form-control" id="tagging_authority" name="tagging_authority" placeholder="Authority" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">Condition before Transfer:</td>
                              <td><input type="text" class="form-control" id="tagging_condition" name="tagging_condition" placeholder="Condition before Transfer" required></td>
                            </tr> 
                            <tr>
                              <td style="float:right;">Date Expected Back to Original Location:</td>
                              <td><input type="date" class="form-control" id="tagging_transferred_date" name="tagging_transferred_date"  required></td>
                            </tr>
                            <tr>
                              <td style="float:right;">Region:</td>
                              <td><input type="text" class="form-control" id="tagging_region" name="tagging_region" placeholder="Region" disabled></td>
                            </tr>   
                            <tr>
                              <td style="float:right;">District/Municipal/Assembly:</td>
                              <td><input type="text" class="form-control" id="tagging_district" name="tagging_district" placeholder="Region" disabled></td>
                            </tr>
                            <tr>
                              <td colspan="2"><div align="center"><button type="button" class="btn btn-primary btn-sm " id="department_submit">Tagging of Cards</button></div></td>
                            </tr>                        
                        </table>
                      </div>
                    </div>
